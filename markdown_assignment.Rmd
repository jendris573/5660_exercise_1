...
pheno_mod <- filter(pheno, species=="Acer saccharum")
kable(pheno_mod[1:30, ], caption = 'Table 1. A knitr kable displaying the first 30 phenology observations for sugar maples.')
...
## [And now for something completely different]{style="color:red"}
